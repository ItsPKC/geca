...
class CollegeWebView extends StatefulWidget {
  final Function pageNumberSelector;
  final initialUrl;

  CollegeWebView(this.pageNumberSelector, this.initialUrl);

  @override
  _CollegeWebViewState createState() => _CollegeWebViewState();
}

class _CollegeWebViewState extends State<CollegeWebView> {
                                  ...
                                  ? GestureDetector(
                                      child: Container(
                                        ...
                                        child: CircleAvatar(
                                          ...
                                          backgroundImage:
                                              AssetImage('assets/gecaLogo.png'),
                                          // child: Image(
